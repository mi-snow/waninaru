    ...
    <!--  table cellpadding="0" cellspacing="0"><tr>
      ...
      <ul id="project_container">
        <li><dl class="clearfix">
          <dt><span><?php echo $this->Html->image('../files/'.$project['Project']['image_file_name'],array('url'=>array('controller'=>'projects','action'=>'view' , $project['Project']['id']),'alt'=>'詳しく見る','title'=>'詳しく見る'));?></span></dt>
          <dd class="clearfix">
