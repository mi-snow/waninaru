...
<div id="post_container">
  <div id="post_top_container">
    <h2 id="post_top_title">企画を投稿する</h2>
    <p id="post_top_text">
  ...
  <div id="form_container">
      ...
      <ul>
        ...
        <li><dl class="clearfix">
          ...
          <dd>
            <span class="form_area">
            <?php echo $this->Form->input('Project.people_maxnum', array('after' => '　人', 'type'=>'text','class'=>'xsmall_area tipped')); ?></span>
            <?php echo $valerror['people_maxnum']; ?>
            <span class="attention_area">
              <span class="attention_area_inner">
                企画参加者の最大人数を設定します。<br />
