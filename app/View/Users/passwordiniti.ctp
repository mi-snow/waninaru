...
<!-- ここから編集してください！！！！ -->
 <div id="main_container">
   <div id="passwordiniti_container">
     ...
     <?php echo $this->Form->create('User',array('novalidate' => true,'inutDefaults' => array('label' => false,'div' => false))); ?>
      ...
      <?php echo $this->Form->submit('初期化',array('label' => false,'div' => false,'class'=>'user_submit_btn','onClick'=>"return confirm('パスワードを初期化しますか？')")); ?>

     <?php $this->Form->end(); ?>



   </div><!-- end passwordiniti_container -->
